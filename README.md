...
pip install sounddeviceThe first two commands install dependencies, and the last one installs sounddevice which is a library we’ll be using to take recordings with.
